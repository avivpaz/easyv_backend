...
const { createJob, getOrganizationJobs, getJob, getJobCVs, uploadJobCVs ,deleteJob,generateJobDescription,generateSocialShare,updateJob} = require('../controllers/jobController');
